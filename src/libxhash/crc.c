...
unsigned int XhCrc32(unsigned int initial, const void* data, size_t size)
{
...
unsigned __int64 XhCrc64(unsigned __int64 initial, const void* data, size_t size)
{
    const unsigned char *p = (const unsigned char*)data;
    unsigned __int64 crc = initial;
